...
.controller('HomeController', ['$scope', 'menuFactory', 'corporateFactory', 'promotionFactory', 'reservationFactory', function ($scope, menuFactory, corporateFactory, promotionFactory, reservationFactory) {
    $scope.showDish = false;
    ...
    $scope.sendReservation = function () {
            if ($scope.reservation.agree && ($scope.reservation.mychannel == "")) {
            $scope.invalidChannelSelection = true;
        } else {
            $scope.invalidChannelSelection = false;
